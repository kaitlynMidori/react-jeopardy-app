    ...
    <div className="boardContainer" >
        ...
        <div className="row 200Row">
            {twoHundredQuestions.map((question)=>{
                return <QuestionCard level='200' question={twoHundredQuestions} categoryID={question.category_id} index={twoHundredQuestions.indexOf(question)}  playersScores={props.playersScores} updateScore={props.updateScore} li key={setTwoHundredQuestions.id} > {setTwoHundredQuestions.text} </QuestionCard>
            })}
        </div>
