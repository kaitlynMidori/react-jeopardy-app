 ...
 playersScores.forEach((element) => {
  ...
  return (
    <div className="container mt-4">
          ...
          <Container>
            ...
            <Box direction="row-responsive" gap="small" alignContent="center">
              {playersScores.map((player, index) => {
                return <PlayerScore player={playersScores} key={index} updateName={updateName} index={index} />
              })}
            </Box>
          </Container>
        </div>
      ...
      <div className="row">
      <Board playersScores={playersScores, index} key={index} updateScore={updateScore} index={index}/>
